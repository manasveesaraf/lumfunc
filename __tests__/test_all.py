"""This file tests the following functions:
    ...
    * get_volume - yes
    * get_binned_phi - yes
    * get_patch_centers - yes
    * get_patch_labels - yes
    * get_binned_phi_error - yes
    * get_plot - yes
    * filter_plot_by_colour - yes
    * SchechterMagModel - yes
    * DoubleSchechterMagModel - yes
    * get_gof - yes
    * get_schechter_phi - yes
    * get_double_schechter_phi - yes
...
def test_get_plot( ):
    ...
    test_result = cv2.imread('test_LF.png')
    pytest_result = cv2.imread('pytest_LF.png')
    difference = cv2.subtract(test_result, pytest_result)
    b, g, r = cv2.split(difference)
    assert test_result.shape == pytest_result.shape
    assert cv2.countNonZero(b) == 0
...
def test_filter_plot_by_colour( ):
    ...
    test_result = cv2.imread('test_LF_colour.png')
    pytest_result = cv2.imread('pytest_LF_colour.png')
    difference = cv2.subtract(test_result, pytest_result)
    b, g, r = cv2.split(difference)
    assert test_result.shape == pytest_result.shape
    assert cv2.countNonZero(b) == 0
...
def test_get_schechter_phi_all( ):
    ...
    test_result = cv2.imread('test_all_Sch.png')
    pytest_result = cv2.imread('pytest_all_Sch.png')
    difference = cv2.subtract(test_result, pytest_result)
    b, g, r = cv2.split(difference)
    assert test_result.shape == pytest_result.shape
    assert cv2.countNonZero(b) == 0
...
def test_get_schechter_phi_blue( ):
    ...
    test_result = cv2.imread('test_blue_Sch.png')
    pytest_result = cv2.imread('pytest_blue_Sch.png')
    difference = cv2.subtract(test_result, pytest_result)
    b, g, r = cv2.split(difference)
    assert test_result.shape == pytest_result.shape
    assert cv2.countNonZero(b) == 0
...
def test_get_double_schechter_phi_red( ):
    ...
    test_result = cv2.imread('test_red_dSch.png')
    pytest_result = cv2.imread('pytest_red_dSch.png')
    difference = cv2.subtract(test_result, pytest_result)
    b, g, r = cv2.split(difference)
    assert test_result.shape == pytest_result.shape
    assert cv2.countNonZero(b) == 0
