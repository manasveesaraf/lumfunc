...
def test_get_plot( ):
    ...
    plot_M_list, plot_M_err_list, plot_phi_list, plot_phi_err_list = lf.get_plot(
        ...
        plot_savename='__tests__/pytest_LF.png')

    assert list(plot_M_list) == approx([-24.62894308598833, -23.404512811278693, -22.18008253656906, -20.955652261859427, 
        -19.731221987149794, -18.506791712440158, -17.282361437730522, -16.05793116302089, -14.833500888311256, 
        -13.609070613601622], rel=1e-6, abs=9e-4)
    assert list(plot_M_err_list) == approx([0.6122151373548164, 0.6122151373548181, 0.6122151373548164, 0.6122151373548164, 
        0.6122151373548181, 0.6122151373548164, 0.6122151373548181, 0.6122151373548164, 0.6122151373548173, 
        0.6122151373548164], rel=1e-6, abs=9e-4)
    assert list(plot_phi_list) == approx([290.491672773112, 265.7977860159212, 9.55747321361586e-05, 0.0002549444468315998, 
        0.0006247531885987247, 0.001075916507027022, 0.0019105283915257355, 0.005624556120539741, 0.0038603784240661696, 
        0.06417684969053933], rel=1e-6, abs=9e-4)
    assert list(plot_phi_err_list) == approx([810.9397645708841, 607.8170004077618, 4.36417468536423e-05, 0.00019704012356457505, 
    ...
    test_result = cv2.imread('test/test_LF.png')
...
def test_filter_plot_by_colour( ):
    ...
    all_M_list, all_M_err_list, all_phi_list, all_phi_err_list, red_M_list, red_M_err_list, red_phi_list, red_phi_err_list, blue_M_list, blue_M_err_list, blue_phi_list, blue_phi_err_list = lf.filter_plot_by_colour(
        ...
        survey='kids',
        numba_installed=True,
        plot_savename='__tests__/pytest_LF_colour.png')
    
    assert list(all_M_list) == approx([-24.62894308598833, -23.404512811278693, -22.18008253656906, -20.955652261859427, 
        -19.731221987149794, -18.506791712440158, -17.282361437730522, -16.05793116302089, -14.833500888311256, 
        -13.609070613601622], rel=1e-6, abs=9e-4)
    assert list(all_M_err_list) == approx([0.6122151373548164, 0.6122151373548181, 0.6122151373548164, 0.6122151373548164, 
        0.6122151373548181, 0.6122151373548164, 0.6122151373548181, 0.6122151373548164, 0.6122151373548173, 
        0.6122151373548164], rel=1e-6, abs=9e-4)
    assert list(all_phi_list) == approx([290.491672773112, 265.7977860159212, 9.55747321361586e-05, 0.0002549444468315998, 
        0.0006247531885987247, 0.001075916507027022, 0.0019105283915257355, 0.005624556120539741, 0.0038603784240661696, 
        0.06417684969053933], rel=1e-6, abs=9e-4)
    assert list(all_phi_err_list) == approx([810.9397645708841, 607.8170004077618, 4.36417468536423e-05, 0.00019704012356457505, 
        0.0005486180652616492, 0.0004654318611417406, 0.0005773328573042754, 0.00459036071996224, 0.00221037276729238, 
        0.164362438153455], rel=1e-6, abs=9e-4)
    assert list(red_M_list) == approx([-23.749705414732908, -23.22313054306747, -22.696555671402038, -22.1699807997366, 
        -21.643405928071164, -21.11683105640573, -20.590256184740294, -20.06368131307486, -19.53710644140942, 
        -19.01053156974399], rel=1e-6, abs=9e-4)
    assert list(red_M_err_list) == approx([0.2632874358327175, 0.2632874358327175, 0.2632874358327175, 0.2632874358327175, 
        0.2632874358327193, 0.26328743583271574, 0.2632874358327193, 0.2632874358327175, 0.2632874358327175, 
        0.2632874358327175], rel=1e-6, abs=9e-4)
    assert list(red_phi_list) == approx([5.262220153129362e-06, 1.146322895875979e-05, 2.2815766050216087e-05, 3.063244885429312e-05, 
        3.784760366971176e-05, 6.955865011705814e-05, 4.601876296333914e-05, 4.2237548701635644e-05, 0.0001626682945797204, 
        5.198919360306014e-05], rel=1e-6, abs=9e-4)
    assert list(red_phi_err_list) == approx([1.6816801547847714e-05, 1.8848825092512034e-05, 2.1415807046810993e-05, 
        3.71536660000855e-05, 5.644501842774335e-05, 3.6815620551692435e-05, 5.656805584781544e-05, 7.501902486045965e-05, 
        0.00015384519165375355, 0.00021127915259708341], rel=1e-6, abs=9e-4)
    assert list(blue_M_list) == approx([-24.62894308598833, -23.404512811278693, -22.18008253656906, -20.955652261859427, 
        -19.731221987149794, -18.506791712440158, -17.282361437730522, -16.05793116302089, -14.833500888311256, 
        -13.609070613601622], rel=1e-6, abs=9e-4)
    assert list(blue_M_err_list) == approx([0.6122151373548164, 0.6122151373548181, 0.6122151373548164, 0.6122151373548164, 
        0.6122151373548181, 0.6122151373548164, 0.6122151373548181, 0.6122151373548164, 0.6122151373548173, 
        0.6122151373548164], rel=1e-6, abs=9e-4)
    assert list(blue_phi_list) == approx([290.491672773112, 265.7977762939234, 6.601873861989515e-05, 0.00019806224916273766, 
        0.0005366319861440035, 0.0010535581878029952, 0.0019105283915257355, 0.005624556120539741, 0.0038603784240661696, 
        0.06417684969053933], rel=1e-6, abs=9e-4)
    assert list(blue_phi_err_list) == approx([810.939765667249, 607.8170014696902, 3.096420475680061e-05, 0.0001368281769262127, 
        0.0005482677763962965, 0.00044155205816259833, 0.0005126210576546734, 0.004590031416295528, 0.002209831427396876, 
        0.16436038459664015], rel=1e-6, abs=9e-4)
    
    test_result = cv2.imread('test/test_LF_colour.png')
